...
- Updated dual-mode Light card tints immediately when switching from RGB colour to colour temperature.
...
[1.1.1]: https://github.com/Jonathanpbk/hearth/compare/v1.1.0...v1.1.1
